...
export default {
  ...
  methods: {
    get_tweet_replies() {
      axios({
        method: "get",
        url: `http://localhost:8000/tweets/${this.id}/replies/`,
      })
        .then((response) => {
    ...
    get_reply_count() {
      axios({
        method: "get",
        url: `http://localhost:8000/tweets/${this.id}/reply-count/`,
      })
        .then((response) => {
    ...
    get_repost_count() {
      axios({
        method: "get",
        url: `http://localhost:8000/tweets/${this.id}/repost-count/`,
      })
        .then((response) => {
    ...
    get_retweet_count() {
      axios({
        method: "get",
        url: `http://localhost:8000/tweets/${this.id}/retweet-count/`,
      })
        .then((response) => {
    ...
    get_quote_count() {
      axios({
        method: "get",
        url: `http://localhost:8000/tweets/${this.id}/quote-count/`,
      })
        .then((response) => {
    ...
    get_like_count() {
      axios({
        method: "get",
        url: `http://localhost:8000/tweets/${this.id}/like-count/`,
      })
        .then((response) => {
    ...
    get_dislike_count() {
      axios({
        method: "get",
        url: `http://localhost:8000/tweets/${this.id}/dislike-count/`,
      })
        .then((response) => {
    ...
    retweet_tweet() {
      axios({
        method: "post",
        url: `http://localhost:8000/tweets/${this.id}/retweet/`,
      })
        .then(() => {
    ...
    quote_tweet() {
      axios({
        method: "post",
        url: `http://localhost:8000/tweets/${this.id}/quote/`,
      })
        .then(() => {
    ...
    get_like_status() {
      axios({
        method: "get",
        url: `http://localhost:8000/tweets/${this.id}/like-status/`,
      })
        .then((response) => {
    ...
    get_dislike_status() {
      axios({
        method: "get",
        url: `http://localhost:8000/tweets/${this.id}/dislike-status/`,
      })
        .then((response) => {
    ...
    get_quote_status() {
      axios({
        method: "get",
        url: `http://localhost:8000/tweets/${this.id}/quote-status/`,
      })
        .then((response) => {
    ...
    get_retweet_status() {
      axios({
        method: "get",
        url: `http://localhost:8000/tweets/${this.id}/retweet-status/`,
      })
        .then((response) => {
